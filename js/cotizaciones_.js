...
$(document).ready(function(e) {
	...
	$(".guardar").click(function(e) {
		if(requerido()){
			...
			dir = document.getElementById("nombreEvento").value;
			noInv = document.getElementById("telefonoContacto").value;
			tel = document.getElementById("noinvitados").value;
			$.ajax({
				url:'scripts/guardaCosas.php',
				cache:false,
				async:false,
				type:'POST',
				data:{

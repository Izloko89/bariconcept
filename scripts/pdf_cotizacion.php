...
<table cellpadding="0" cellspacing="0" style=" font-size:12px;width:100%; margin-top:10px; padding:0 20px;">
	...
	&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Con el gusto de saludarle, pongo a su consideración la propuesta para su Evento "'.$nombreEve.'",
	que se llevara a cabo el próximo '.varFechaAbr($fechaEve).' en '. $dirEve.' para ' . $noIn . ' personas.</div></td>
    </tr>
</table>
<br>

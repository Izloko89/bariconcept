      ...
      <div class="tabla">
        <div class="celda" style=" width:600px;">
          ...
          <div class="campo_form">
			...
			<input type="text" id="telefonoContacto" class="text_largo telefonoContacto"/>
          </div>
        ...
        <div class="celda" style="">
          <div class="campo_form">
        	...
        	<abbr title=""><input placeholder="Click para elegir" class="fecha alejar_izq requerido fechaevento" type="text" name="fechaevento" id="fechaevento" readonly/></abbr><!--
          ...
          <div class="campo_form">
        	...
        	<abbr title=""><input placeholder="Click para elegir" class="fecha alejar_izq requerido fechamontaje" type="text" name="fechamontaje" id="fechamontaje" readonly/></abbr><!--
          ...
          <div class="campo_form">
        	...
        	<abbr title=""><input placeholder="Click para elegir" class="fecha alejar_izq requerido fechadesmont" type="text" name="fechadesmont" id="fechadesmont" readonly/></abbr><!--
